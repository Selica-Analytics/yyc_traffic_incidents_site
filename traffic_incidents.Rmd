...
Traffic cameras are identified by the blue markers with the video camera icon. You can toggle the camera markers on and off by clicking the layers icon in the top right corner of the map. Clicking on the traffic camera marker will allow you to navigate to the live traffic images **(this feature currently doesn't work)**.
...
```{r, fig.align="center", fig.width=18, fig.height = 9,fig.cap="License: Contains information licensed under the Open Government Licence – City of Calgary."}
leaflet() |>
 addTiles() |>
    addAwesomeMarkers(
    ...
    addAwesomeMarkers(
        ...
        popup = traffic_cams$content,
        icon = icons[traffic_cams$type],
        group = "Traffic Cams"
        ) |>
    addLayersControl(
    baseGroups = c("Traffic Cams","Turn off Traffic Cams"),
    position = "topright"
  )
```
```
