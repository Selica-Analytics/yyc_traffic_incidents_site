...
combined_data <- bind_rows(traffic_incidents,construction_detours)
...
```{r, fig.align="center", fig.width=10, fig.cap="License: Contains information licensed under the Open Government Licence – City of Calgary."}
